...
def currency_converter(amount, from_currency, to_currency):
    ...
    rates = {'USD': 1.0, 'EUR': 0.87, 'PKR': 279.13, 'INR': 82.89}
...
def main():
    ...
    from_currency = st.selectbox("From Currency:", options=['USD', 'EUR', 'PKR', 'INR'])
    to_currency = st.selectbox("To Currency:", options=['USD', 'EUR', 'PKR', 'INR'])
